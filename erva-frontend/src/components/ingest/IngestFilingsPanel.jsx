    ...
    <div className="bg-[#111827] border border-[#2D3748] rounded-lg overflow-hidden">
      <div className="px-4 py-3 border-b border-[#2D3748] flex items-center justify-between">
        <div className="flex items-center gap-2">
          <p className="text-xs text-[#4B5563] uppercase tracking-wider font-medium">Payment Processor STR Filings</p>
      ...
      {isLoading ? (
        ...
        <div className="py-10 text-center">
          <p className="text-sm text-[#94A3B8]">No STRs filed via payment processor yet</p>
