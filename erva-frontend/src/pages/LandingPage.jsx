...
function DeploymentDiagram() {
  return (
    <svg
      ...
      role="img"
      aria-label="ERVA deployment architecture diagram showing ERVA Engine, Neo4j graph database, and PostgreSQL inside a bank infrastructure boundary. Transactions flow in from outside; STR reports flow out to NFIU."
    >
      <defs>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <div className="flex items-center gap-3 mb-8">
                ...
                >
                  QuantumHacks 2026 · Databases &amp; Fintech
                </div>
              </div>
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <div className="lg-fade grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-px rounded-xl overflow-hidden mb-16" style={{ border: '1px solid #1E3358', background: '#1E3358' }}>
            {[
              ...
              { n: '05', title: 'Isolate the Ring',  desc: 'Flagged clusters are reformulated as a quantum-inspired QUBO optimization and solved with simulated annealing, benchmarked against the classical heuristic to find the tightest core ring.' },
              { n: '06', title: 'Report',  desc: 'ERVA drafts the NFIU-compliant STR automatically from the graph evidence. A human analyst always reviews and approves before it is filed — reports are never auto-filed.' },
            ].map(({ n, title, desc }) => (
              <div
                key={n}
          ...
          <div className="grid sm:grid-cols-2 gap-5">
              {[
                ...
                },
                {
                  ...
                  body: 'Clean naira enters a P2P crypto channel, moves through stablecoins, and re-emerges in the formal banking system appearing legitimate. The entry and exit points are the tell — ERVA catches them.',
                  delay: '160ms',
                },
                {
                  title: 'Shell Director Webs',
                  body: 'Three businesses. Two shared directors. One registered address. All transacting with each other. Each entity passes individual verification. In ERVA\'s graph, the web is immediate.',
                  delay: '240ms',
                },
            ...
            {[
              {
                ...
                body: 'Every entity in your institution, mapped in real time. Risk scores propagate across connected nodes the moment a pattern is detected, live from your connected payment processor.',
                delay: '0ms',
              },
              {
                icon: <IconFileText className="w-6 h-6" style={{ color: BRAND_FROM }} />,
                title: 'Automated STR Drafting',
                body: 'When suspicious patterns are confirmed, ERVA drafts a complete Suspicious Transaction Report (STR) — the mandatory regulatory filing for confirmed fraud — from the graph evidence. Your analyst reviews, edits, and approves before anything is filed. Every compliance decision is recorded with a transaction reference, financially traceable and immutably logged.',
                delay: '80ms',
              },
              {
                icon: <IconShield className="w-6 h-6" style={{ color: BRAND_FROM }} />,
                title: 'Immutable Audit Trail',
                body: 'Every detection, review, and decision logged with a cryptographic hash. Built for NFIU (Nigeria’s Financial Intelligence Unit, the regulator that receives STR filings) and CBN inspection. NDPA-compliant by design.',
                delay: '160ms',
              },
            ].map(({ icon, title, body, delay }) => (
              <div
        ...
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          <div className="lg-fade" style={{ maxWidth: '680px', margin: '0 auto' }}>
            ...
            <p className="mt-6" style={{ fontSize: '0.85rem', color: '#475569' }}>
              No login required. The full pipeline is live — payment-processor webhook ingestion, graph detection, quantum-inspired ring isolation, STR generation. See it run.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid sm:grid-cols-3 gap-10 mb-10">
            ...
            <div>
              ...
              <p style={{ fontSize: '0.85rem', color: '#475569', lineHeight: 1.65 }}>
                ERVA — Entity Risk &amp; Verification Analytics. Network-based trust verification for Nigeria, processor-agnostic by design.
              </p>
            </div>
