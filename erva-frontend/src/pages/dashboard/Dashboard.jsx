...
import { IngestFeed } from '@/components/dashboard/IngestFeed'
...
export default function Dashboard() {
  ...
  return (
    <div>
      ...
      {/* ERVA Trust Intelligence Banner */}
        ...
        <div className="mb-5 bg-red-500/5 border border-red-500/20 rounded-lg p-4 flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-[#94A3B8] mt-0.5">
              {highRiskIds.size} entities flagged · ERVA is monitoring {entityTotal ?? '…'} entities in real time
            </p>
          </div>
          <button
          ...
          <div className="bg-[#0D1117] border border-[#BE185D]/30 rounded-lg p-5 flex flex-col gap-4">
            <div>
              ...
              <p className="text-sm text-[#94A3B8] leading-relaxed">
                Trigger a live payment-processor transaction and watch ERVA detect fraud patterns in real time.
              </p>
            </div>
            <IngestLiveTrigger />
            <div className="pt-2 border-t border-[#1C2333] space-y-1">
              {[
                'Payment processor → ERVA ingest',
      ...
      {aiMetrics && (
        <div className="mb-6 bg-[#111827] border border-[#2D3748] rounded-lg p-4">
          <div className="flex items-center justify-between mb-3">
            <p className="text-xs text-[#4B5563] uppercase tracking-wider font-medium">ERVA Responsible AI</p>
