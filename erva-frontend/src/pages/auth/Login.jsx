...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    login({ name: 'Akeem Jr.', email, role: 'CCO' }, 'mock-jwt-token-erva-2026')
    navigate('/dashboard')
  }
      ...
      <div className="text-center mb-8">
        <div className="flex items-center justify-center gap-2 mb-4">
          <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full brand-gradient-bg">
            ...
            <span className="text-[10px] font-bold text-white uppercase tracking-wide">QuantumHacks 2026</span>
          </span>
        </div>
