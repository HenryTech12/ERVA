...
from app.services.quantum_ring_service import isolate_ring
...
@router.post("/alerts/{alert_id}/quantum-isolate")
def quantum_isolate_alert(
    alert_id: UUID,
    db: Session = Depends(get_db),
) -> dict:
    row = db.get(Alert, alert_id)
