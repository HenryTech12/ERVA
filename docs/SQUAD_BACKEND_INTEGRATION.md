# Squad Backend Integration (ERVA)

This document guides backend integration of Squad into the existing ERVA pipeline. It focuses on the minimal, correct implementation and operational steps to ensure the integration works end-to-end without disrupting the current ingestion, detection, and STR workflows.
...
- Use Squad sandbox simulator to fire a test transaction into ERVA.
